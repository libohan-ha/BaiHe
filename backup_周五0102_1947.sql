...
\restrict 66Sq6SZ1QdZ11c3YaTrr9Cu6UrY9o4aQxNZTrM9taWaTp9GfKkko27ercJD74EC
...
--
-- Name: AICharacter; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public."AICharacter" (
    ...
    "backgroundUrl" text,
    "modelName" text DEFAULT 'deepseek-chat'::text NOT NULL,
    "bubbleOpacity" integer DEFAULT 85 NOT NULL,
...
ALTER TABLE public."AICharacter" OWNER TO postgres;
...
CREATE TABLE public."Article" (
    ...
    status public."ArticleStatus" DEFAULT 'PUBLISHED'::public."ArticleStatus" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL
);
...
--
-- Name: ImageCollection; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."ImageCollection" OWNER TO postgres;

--
-- Name: ImageTag; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."ImageTag" OWNER TO postgres;
...
--
-- Name: _ImageToImageTag; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."_ImageToImageTag" (
    "A" text NOT NULL,
    "B" text NOT NULL
);


ALTER TABLE public."_ImageToImageTag" OWNER TO postgres;
...
--
-- Name: AICharacter AICharacter_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."AICharacter"
    ADD CONSTRAINT "AICharacter_pkey" PRIMARY KEY (id);
...
--
-- Name: ImageCollection ImageCollection_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ImageCollection"
    ADD CONSTRAINT "ImageCollection_pkey" PRIMARY KEY (id);


--
-- Name: ImageTag ImageTag_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ImageTag"
...
--
-- Name: _ImageToImageTag _ImageToImageTag_AB_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."_ImageToImageTag"
    ADD CONSTRAINT "_ImageToImageTag_AB_pkey" PRIMARY KEY ("A", "B");
...
--
-- Name: AICharacter_userId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "AICharacter_userId_idx" ON public."AICharacter" USING btree ("userId");


--
-- Name: Article_authorId_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: Article_createdAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Article_createdAt_idx" ON public."Article" USING btree ("createdAt");
...
--
-- Name: Collection_articleId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Collection_articleId_idx" ON public."Collection" USING btree ("articleId");


--
-- Name: Collection_userId_articleId_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "Collection_userId_articleId_key" ON public."Collection" USING btree ("userId", "articleId");
...
--
-- Name: Comment_imageId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Comment_imageId_idx" ON public."Comment" USING btree ("imageId");
...
--
-- Name: Conversation_characterId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Conversation_characterId_idx" ON public."Conversation" USING btree ("characterId");


--
-- Name: Conversation_userId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Conversation_userId_idx" ON public."Conversation" USING btree ("userId");


--
-- Name: ImageCollection_imageId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "ImageCollection_imageId_idx" ON public."ImageCollection" USING btree ("imageId");


--
-- Name: ImageCollection_userId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "ImageCollection_userId_idx" ON public."ImageCollection" USING btree ("userId");


--
-- Name: ImageCollection_userId_imageId_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "ImageCollection_userId_imageId_key" ON public."ImageCollection" USING btree ("userId", "imageId");


--
-- Name: ImageTag_name_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "ImageTag_name_idx" ON public."ImageTag" USING btree (name);


--
-- Name: ImageTag_name_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "ImageTag_name_key" ON public."ImageTag" USING btree (name);


--
-- Name: Image_createdAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Image_createdAt_idx" ON public."Image" USING btree ("createdAt");


--
-- Name: Image_uploaderId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Image_uploaderId_idx" ON public."Image" USING btree ("uploaderId");
...
--
-- Name: _ImageToImageTag_B_index; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "_ImageToImageTag_B_index" ON public."_ImageToImageTag" USING btree ("B");


--
-- Name: AICharacter AICharacter_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."AICharacter"
    ADD CONSTRAINT "AICharacter_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: Collection Collection_articleId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Collection"
    ADD CONSTRAINT "Collection_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES public."Article"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public."Comment"
    ADD CONSTRAINT "Comment_imageId_fkey" FOREIGN KEY ("imageId") REFERENCES public."Image"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: Conversation Conversation_characterId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Conversation"
    ADD CONSTRAINT "Conversation_characterId_fkey" FOREIGN KEY ("characterId") REFERENCES public."AICharacter"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: ImageCollection ImageCollection_imageId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ImageCollection"
    ADD CONSTRAINT "ImageCollection_imageId_fkey" FOREIGN KEY ("imageId") REFERENCES public."Image"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ImageCollection ImageCollection_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ImageCollection"
    ADD CONSTRAINT "ImageCollection_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: Image Image_uploaderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Image"
    ADD CONSTRAINT "Image_uploaderId_fkey" FOREIGN KEY ("uploaderId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: _ImageToImageTag _ImageToImageTag_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."_ImageToImageTag"
    ADD CONSTRAINT "_ImageToImageTag_A_fkey" FOREIGN KEY ("A") REFERENCES public."Image"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: _ImageToImageTag _ImageToImageTag_B_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."_ImageToImageTag"
    ADD CONSTRAINT "_ImageToImageTag_B_fkey" FOREIGN KEY ("B") REFERENCES public."ImageTag"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict 66Sq6SZ1QdZ11c3YaTrr9Cu6UrY9o4aQxNZTrM9taWaTp9GfKkko27ercJD74EC
